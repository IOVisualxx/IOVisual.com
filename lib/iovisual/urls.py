...
from .toptopic.models import NewsItem
...
urlpatterns = patterns('',
    ...
    url(r'^projects$', direct_to_template, {'template': 'about.html'}, name='projects'),
    url(r'^services$', direct_to_template, {'template': 'about.html'}, name='services'),
)
#) + patterns('',
